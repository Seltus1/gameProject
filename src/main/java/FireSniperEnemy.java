...
public class FireSniperEnemy extends StationaryEnemy{
    private Fire fire;
    private  int burnCountDown;

    public FireSniperEnemy(int hp, int damage, int posX, int posY, int moveSpeed, int size, int fireRange, int shotRange, int shotSpeed, Raylib.Color color){
